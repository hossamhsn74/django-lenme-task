...
urlpatterns = [
    ...
    path('request/<int:pk>/', views.RequestDetailView.as_view(), name='requestDetails'),
    path('offer/', views.OfferListView.as_view(), name='offersList'),
    path('offer/create/', views.OfferCreateView.as_view()),
    path('offer/<int:pk>/', views.OfferDetailView.as_view(), name='offerDetails'),
